...
class _ReconstitutionScreenState extends State<ReconstitutionScreen> {
  ...
  Future<void> _saveReconstitution(BuildContext context) async {
        ...
        builder: (context) => AlertDialog(
              ...
              title: const Text(
                ...
                style: TextStyle(
                  ...
                  fontSize: 22,
                  shadows: [
                    Shadow(color: AppConstants.primaryColor, blurRadius: 2)
                  ],
                ),
              ),
              content: Padding(
                ...
                child: RichText(
                  text: TextSpan(
                    ...
                    children: [
                      ...
                      TextSpan(
                          text:
                              '${_formatNumber(_targetDose)} $_targetDoseUnit\n'),
                      const TextSpan(
                          text: 'Administer ',
                          style: TextStyle(
                              fontWeight: FontWeight.bold,
                      ...
                      TextSpan(
                        text:
                            '${_formatNumber(_selectedReconstitution!['syringeUnits'])} IU',
                        style: const TextStyle(
                            color: Colors.grey), // Un-bolded IU value
                      ),
                      const TextSpan(
                          text: ' via ',
                          style: TextStyle(
                              color: Colors.grey)),
                      TextSpan(
                          text: '${_formatNumber(_syringeSize)} mL Syringe',
                          style: const TextStyle(
                              fontWeight: FontWeight.bold,
                              color: Colors.black)),
                    ],
    ...
    try {
      ...
      if (context.mounted) {
        Navigator.pushReplacementNamed(context, '/medication_details',
  ...
  Widget build(BuildContext context) {
    final targetDoseUnits =
        widget.medication.quantityUnit == 'mg' ? ['mg', 'mcg'] : ['mcg', 'mg'];
            ...
            children: [
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  labelText:
                      'Reconstitution Fluid (e.g., Bacteriostatic Water)',
                  ...
                  child: RichText(
                    text: TextSpan(
                      ...
                      children: [
                        ...
                        TextSpan(
                          text:
                              _formatNumber(_selectedReconstitution!['volume']),
                          style: const TextStyle(fontWeight: FontWeight.bold),
                        ),
                        const TextSpan(
                            text: ' mL',

...
class _MedicationFormViewState extends State<MedicationFormView> {
  ...
  void initState() {
    ...
    if (widget.medication != null) {
      ...
      _dosePerTabletController.text = widget.medication!.dosePerTablet != null
          ...
          : '';
      _dosePerTabletUnit = widget.medication!.dosePerTabletUnit ?? QuantityUnit.mg;
      _dosePerCapsuleController.text = widget.medication!.dosePerCapsule != null
          ? formatNumber(widget.medication!.dosePerCapsule!)
          : '';
      _dosePerCapsuleUnit = widget.medication!.dosePerCapsuleUnit ?? QuantityUnit.mg;
  ...
  Future<void> _saveMedication(BuildContext context) async {
    ...
    final medication = Medication(
      ...
      quantityUnit: unit,
      remainingQuantity: widget.medication?.remainingQuantity ?? double.parse(_quantityController.text),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          title: Text(widget.medication == null ? 'Add Medication' : 'Edit Medication', style: const TextStyle(fontFamily: 'Inter')),
    ...
    decoration: AppThemes.infoCardDecoration(isDark),
    child: Text(
    ...
    value: (_type == MedicationType.tablet || _type == MedicationType.capsule) ? QuantityUnit.tablets : _quantityUnit,
    decoration: AppConstants.formFieldDecoration(isDark).copyWith(
    labelText: 'Unit',
    labelStyle: AppThemes.formLabelStyle(isDark),
    ),
    items: (_type == MedicationType.tablet || _type == MedicationType.capsule)
    ...
    child: Text(unit.displayName, style: const TextStyle(fontFamily: 'Inter')),
        ...
        .toList(),
    onChanged: (value) => setState(() => _quantityUnit = value ?? _quantityUnit),

...
class _DosageFormScreenState extends State<DosageFormScreen> {
  ...
  Future<void> _saveDosage(BuildContext context) async {
      ...
      final confirmed = await showDialog<bool>(
        ...
        builder: (context) => AlertDialog(
          ...
          title: Text('Volume Required',
              style: Themes.warningTitleStyle),
    ...
    final confirmed = await showDialog<bool>(
      context: context,
      builder: (context) => AlertDialog(
        backgroundColor: Themes.informationBackgroundColor,
        title: Text(widget.dosage == null ? 'Add Dosage' : 'Update Dosage',
            style: Themes.informationTitleStyle),
        content: RichText(
          text: TextSpan(
            style: Themes.informationContentTextStyle
                ?.copyWith(height: 1.5),
            children: [
              const TextSpan(
                  text: 'Dosage: ',

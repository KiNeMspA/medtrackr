// In lib/widgets/dialogs/confirm_medication_dialog.dart, verify content
    ...
    return AlertDialog(
      ...
      content: Container(
        ...
        child: Column(
          ...
          children: [
            Text('Confirm Medication', style: Themes.informationTitleStyle),
            ...
            RichText(
              text: TextSpan(
                ...
                children: [
                  ...
                  if (isTabletOrCapsule && medication.dosePerTablet != null && type == MedicationType.tablet)
                    TextSpan(
                      text: '\nDose per Tablet: ',
                  ...
                  if (isTabletOrCapsule && medication.dosePerCapsule != null && type == MedicationType.capsule)
                    TextSpan(
                      text: '\nDose per Capsule: ',
                      style: const TextStyle(fontWeight: FontWeight.bold),
                      children: [
